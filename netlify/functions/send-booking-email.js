...
exports.handler = async (event) => {
  ...
  const { name, email, phone, date, time, guests, floorSeating, specialRequests } = JSON.parse(event.body);
  ...
  let mailOptions = {
    ...
    text: `
      ...
      Time: ${time}
      Guests: ${guests}
      Floor Seating: ${floorSeating ? 'Yes' : 'No'}
    ...
    html: `
      ...
      <p><strong>Floor Seating:</strong> ${floorSeating ? 'Yes' : 'No'}</p>
